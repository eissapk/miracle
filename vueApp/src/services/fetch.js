function handlePages() {
  return new Promise((resolve, reject) => {
    ...
    function recursive(num) {
      ...
      // bind surahs
      surahs.push({ ayahs: surah.ayahs.map(item => {return {page:item.page,localVerse: item.localVerse, globalVerse: item.globalVerse}}),juz: surah.ayahs[0].juz, page: surah.ayahs[0].page, name: surah.name, surah: surah.surah, type: surah.type, verses: surah.verses });
      // bind pages
